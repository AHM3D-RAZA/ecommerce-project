                    ...
                    <div class="form-box">
                        <div class="form-tab">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link<?= $signinActive ? ' active' : '' ?>" id="signin-tab-2" data-toggle="tab" href="#signin-2" role="tab" aria-controls="signin-2" aria-selected="<?= $signinActive ? 'true' : 'false' ?>">Sign In</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link<?= $signinActive ? '' : ' active' ?>" id="register-tab-2" data-toggle="tab" href="#register-2" role="tab" aria-controls="register-2" aria-selected="<?= $signinActive ? 'false' : 'true' ?>">Register</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane fade<?= $signinActive ? ' show active' : '' ?>" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
                                    ...
                                    <form action="login.php" method="post">
                                        ...
                                        <div class="form-footer">
                                            <button type="submit" name="login" value="1" class="btn btn-outline-primary-2">
                                                <span>LOG IN</span>
                                ...
                                <div class="tab-pane fade<?= $signinActive ? '' : ' show active' ?>" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                                    ...
                                    <form action="register.php" method="post">
                                        ...
                                        <div class="form-footer">
                                            <button type="submit" name="register" value="1" class="btn btn-outline-primary-2">
                                                <span>SIGN UP</span>
                                                <i class="icon-long-arrow-right"></i>
                                            </button>
                                        </div><!-- End .form-footer -->
